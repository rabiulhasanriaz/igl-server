...
class CreateLoadCampaignFailedsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('load_campaign_faileds', function (Blueprint $table) {
            $table->increments('id');
            $table->string('user_id')->comment('The user who has made this load');
    ...
    {
        Schema::dropIfExists('load_campaign_faileds');
    }
}