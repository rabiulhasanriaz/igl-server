...
class CreateLoadApiNewBalanceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('load_api_new_balance', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('load_api_new_balance');
    }
}
