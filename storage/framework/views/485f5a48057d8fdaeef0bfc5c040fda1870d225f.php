...
<?php $__env->startSection('campaign_menu_class','active'); ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 padding">
                ...
                <div class="tab-pane fade active in" id="campaign_sms_send">
                    <form action="<?php echo e(route('user.sms.storeCampaignSms')); ?>" id="campaign_sms_send_form" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <table id = "all_category" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $phonebookCampaignCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($loop->index+1); ?></td>
                                        <td>
										<span>
											<input type="radio" class="ace" id="select_<?php echo e($loop->index); ?>" name="group_name" value="<?php echo e($category->id); ?>" required="">
											<label class="lbl" for="select_<?php echo e($loop->index); ?>">&nbsp; <?php echo e($category->name); ?></label>
										</span>
                                        </td>

                                        <td style="text-align: right;"><?php echo e(count($category->CampaignContacts)); ?></td>
                                    </tr>
...
<?php $__env->startSection('custom_script'); ?>
    ...
    <script type="text/javascript">
        ...
        sms_send_form_submit('campaign_sms_send_form', '<?php echo e(route('user.sms.storeCampaignSms')); ?>');
    </script>
<?php $__env->stopSection(); ?>
