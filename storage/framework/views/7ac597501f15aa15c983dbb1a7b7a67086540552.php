...
<div class="wrap">
    ...
    <?php if(session('success')): ?><div class="flash flash-success"><?php echo e(session('success')); ?></div><?php endif; ?>
    <?php if(session('error')): ?><div class="flash flash-error"><?php echo e(session('error')); ?></div><?php endif; ?>
        ...
        <?php if(count($logs)): ?>
            <table>
                ...
                <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="file-name"><?php echo e($log['name']); ?></td>
                        <td><?php echo e($log['size']); ?></td>
                        <td><?php echo e($log['modified']); ?></td>
                        <td><div class="actions">
                            <a class="btn btn-view" href="<?php echo e(route('log-viewer.show', ['filename' => $log['name']])); ?>">View</a>
                            <a class="btn btn-download" href="<?php echo e(route('log-viewer.download', ['filename' => $log['name']])); ?>">Download</a>
                            <form method="POST" action="<?php echo e(route('log-viewer.clear', ['filename' => $log['name']])); ?>" onsubmit="return confirm('Clear this log file?');"><?php echo e(csrf_field()); ?><button class="btn btn-clear" type="submit">Clear</button></form>
                            <form method="POST" action="<?php echo e(route('log-viewer.delete', ['filename' => $log['name']])); ?>" onsubmit="return confirm('Delete this log file?');"><?php echo e(csrf_field()); ?><?php echo e(method_field('DELETE')); ?><button class="btn btn-delete" type="submit">Delete</button></form>
                        </div></td>
                    </tr>
