...
<?php $__env->startSection('rejected_sms_report_menu_class','active'); ?>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                <?php ($serial=1); ?>
                <?php if($rejected_campaigns): ?>
                    <?php $__currentLoopData = $rejected_campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rejected_campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($serial++); ?></td>
                            <td title="<?php echo e($rejected_campaign->sci_campaign_id); ?>"><?php echo e($rejected_campaign->sci_campaign_title); ?></td>
                            <td><?php echo e($rejected_campaign->sci_targeted_time->format('H:i a, d-M-Y')); ?></td>
                            <td><?php echo e($rejected_campaign->sender->sir_sender_id); ?></td>
                            <td class="text-center"><?php echo e($rejected_campaign->sci_total_submitted); ?></td>
                            <td class="text-right">BDT <?php echo e(number_format($rejected_campaign->sci_total_cost, 2)); ?></td>
                            <td class="text-right">BDT <?php echo e(number_format($rejected_campaign->sci_total_cost, 2)); ?></td>
                            <td>
