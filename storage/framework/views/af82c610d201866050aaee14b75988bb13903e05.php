                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-actions">
                            <a href="<?php echo e(route('igl.send')); ?>" class="btn btn-primary btn-sm">
                                <i class="fa fa-refresh"></i> Refresh
                            </a>
                            <a href="<?php echo e(route('igl.test')); ?>" class="btn btn-info btn-sm" target="_blank">
                                <i class="fa fa-flask"></i> Test Connection
                            </a>
                            <a href="<?php echo e(route('igl.sim-profiles')); ?>" class="btn btn-success btn-sm" target="_blank">
                                <i class="fa fa-list"></i> SIM Profiles
                            </a>
                            <a href="<?php echo e(route('igl.balance')); ?>" class="btn btn-warning btn-sm" target="_blank">
                    ...
                    <div class="card-body">
                        ...
                        <?php if(isset($error)): ?>
                            <div class="alert alert-danger alert-dismissible">
                                <strong><i class="fa fa-exclamation-triangle"></i> Error!</strong> <?php echo e($error); ?>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-8">
                                                ...
                                                <h2 class="mb-0"><?php echo e($rest_pendings ?? 0); ?></h2>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-8">
                                                ...
                                                <h2 class="mb-0"><?php echo e($success_count ?? 0); ?></h2>
                                            </div>
                                            <div class="col-4 text-right">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-8">
                                                ...
                                                <h2 class="mb-0"><?php echo e($failed_count ?? 0); ?></h2>
                                            </div>
                                            <div class="col-4 text-right">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-8">
                                                ...
                                                <h6 class="mb-0"><?php echo e(now()->format('H:i:s')); ?></h6>
                                        ...
                                        <div class="row text-center">
                                            <div class="col-md-2">
                                                <div class="bg-danger text-white p-3 rounded">
                                                    <h5>GP</h5>
                                                    <h3><?php echo e($gp_pending ?? 0); ?></h3>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="bg-success text-white p-3 rounded">
                                                    <h5>Airtel</h5>
                                                    <h3><?php echo e($airtel_pending ?? 0); ?></h3>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="bg-warning text-white p-3 rounded">
                                                    <h5>Banglalink</h5>
                                                    <h3><?php echo e($bl_pending ?? 0); ?></h3>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="bg-info text-white p-3 rounded">
                                                    <h5>Robi</h5>
                                                    <h3><?php echo e($robi_pending ?? 0); ?></h3>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="bg-secondary text-white p-3 rounded">
                                                    <h5>Teletalk</h5>
                                                    <h3><?php echo e($tt_pending ?? 0); ?></h3>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="bg-dark text-white p-3 rounded">
                                                    <h5>Total</h5>
                                                    <h3><?php echo e(($gp_pending ?? 0) + ($airtel_pending ?? 0) + ($bl_pending ?? 0) + ($robi_pending ?? 0) + ($tt_pending ?? 0)); ?></h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e($result['sms_id'] ?? '-'); ?></td>
                                                        <td><?php echo e($result['phone'] ?? '-'); ?></td>
                                                        <td>TK <?php echo e($result['amount'] ?? '-'); ?></td>
                                                        <td>
                                                            <?php if($result['status'] == 'success'): ?>
                                                                <span class="badge badge-success">Success</span>
                                                            <?php elseif($result['status'] == 'failed'): ?>
                                                                <span class="badge badge-danger">Failed</span>
                                                            <?php elseif($result['status'] == 'retry'): ?>
                                                                <span class="badge badge-warning">Retry</span>
                                                            <?php elseif($result['status'] == 'duplicate'): ?>
                                                                <span class="badge badge-info">Duplicate</span>
                                                            <?php else: ?>
                                                                <span class="badge badge-secondary"><?php echo e($result['status']); ?></span>
                                                            <?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <?php if(isset($result['transaction_id'])): ?>
                                                                <small><?php echo e($result['transaction_id']); ?></small>
                                                            <?php else: ?>
                                                                -
                                                            <?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <small><?php echo e($result['message'] ?? $result['error'] ?? '-'); ?></small>
                                                        </td>
                                                        <td>
                                                            <small><?php echo e(now()->format('H:i:s')); ?></small>
                                                        </td>
                                                    </tr>
