...
<script type="text/javascript" src="<?php echo e(asset('assets/vue/vue.min.js')); ?>"></script>
...
<script>
   Vue.filter('formatDate', function(value) {
    ...
    let app = new Vue({
        el: '#app',
        data: {
            balance_bd: <?php echo json_encode($balance_bd); ?>,
            sms_credit: <?php echo json_encode($data['sms_credit']); ?>,
            transaction: <?php echo json_encode($data['transactions']); ?>,
            monthly_sms: <?php echo json_encode($data['monthly_sms']); ?>,
            monthly_flexiload: <?php echo json_encode($data['monthly_flexiload']); ?>,
            last_week_sms: <?php echo json_encode($data['last_week_sms']); ?>,
            last_week_cost: <?php echo json_encode($data['last_week_cost']); ?>,
            last_month_sms: <?php echo json_encode($data['last_month_sms']); ?>,
            last_month_cost: <?php echo json_encode($data['last_month_cost']); ?>,
        },
        computed: {
