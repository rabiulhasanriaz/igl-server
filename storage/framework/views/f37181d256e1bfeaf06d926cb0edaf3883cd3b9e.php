...
<body class="no-skin">
	...
	<?php echo $__env->make('reseller.partials.header', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<?php echo $__env->make('reseller.partials.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

		<div class="main-content">
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">

					<?php echo $__env->yieldContent('page_location'); ?>
		...
		<?php echo $__env->make('reseller.partials.footer', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<![endif]-->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            let postUrl = "<?php echo e(route('update-login-status')); ?>";
...
document.getElementById('showBalanceBtn').addEventListener('click', function () {
    ...
    fetch("<?php echo e(route('get-balance')); ?>")
