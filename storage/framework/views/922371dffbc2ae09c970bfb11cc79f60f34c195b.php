...
<div id="header">
            <div class="logo">
                <img src="<?php echo e(OtherHelpers::website_logo()); ?>" alt="">
            </div>
            <div id="footer">
...
<table>
    ...
    <?php $__currentLoopData = $allData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td style="text-align: center; font-size: 13px;"><?php echo e($data->created_at); ?></td>
            <td style="text-align: center; font-size: 13px;"><?php echo e($data->owner_name); ?></td>
            <td style="text-align: center; font-size: 13px;"><?php echo e($data->targeted_number); ?></td>
            <td style="text-align: center; font-size: 13px;"><?php echo e($data->transaction_id); ?></td>
            <td style="text-align: center; font-size: 13px;"><?php echo e($data->remarks); ?></td>
            <td style="text-align: right; font-size: 13px;"><?php echo e($data->campaign_price); ?></td>
        </tr>
        <?php echo e($total +=  $data->campaign_price); ?>
    ...
    <tfoot>
        ...
        <tr>
            <td colspan="7" style="text-align: left;">In Word:- <?php echo e(\OtherHelpers::number_to_text($total)); ?></td>
        </tr>
