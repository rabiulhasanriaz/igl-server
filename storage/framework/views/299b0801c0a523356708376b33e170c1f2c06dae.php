<form action="<?php echo e(route('user.sms.storeGroupContactSms')); ?>" id="group_contact_sms_send" method="post"
    ...
    <div class="form-group">
        ...
        <select class="chosen-select form-control" id="form-field-select-3" data-placeholder="Contact Group"
            ...
            <option value=""></option>
            <?php $__currentLoopData = $phonebookCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phonebookCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($phonebookCategory->id); ?>">
                    <?php echo e($phonebookCategory->name); ?> (<?php echo e(\App\Model\PhonebookContact::where('category_id',$phonebookCategory->id)->count()); ?>)
                </option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
