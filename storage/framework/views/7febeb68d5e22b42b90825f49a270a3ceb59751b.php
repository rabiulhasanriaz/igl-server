...
<?php $__env->startSection('sms_flexi_class','active'); ?>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <table id="sms" class="display nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $sms_user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php ($total_sms += OtherHelpers::total_sms($sms->user_id)); ?>
                        <?php ($total_sms_cost += BalanceHelper::sms_cost($sms->user_id)); ?>
                        <tr>
                            <td><?php echo e(++$sl); ?></td>
                            <td title="<?php echo e($sms->user['company_name']); ?>"><?php echo e($sms->user['cellphone']); ?></td>
                            <td class="text-center"><?php echo e(OtherHelpers::total_sms($sms->user_id)); ?></td>
                            <td class="text-right"><?php echo e(number_format(BalanceHelper::sms_cost($sms->user_id),2)); ?></td>
                        </tr>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th class="text-center"><?php echo e($total_sms); ?></th>
                            <th class="text-right"><?php echo e(number_format($total_sms_cost,2)); ?></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <table id="flexi" class="display nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $flexi_user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $flexi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php ($total_flexi += OtherHelpers::total_flexi($flexi->user_id)); ?>
                        <?php ($total_flexi_cost += BalanceHelper::flexi_cost($flexi->user_id)); ?>
                        <tr>
                            <td><?php echo e(++$sl); ?></td>
                            <td title="<?php echo e($flexi->trx_user['company_name']); ?>"><?php echo e($flexi->trx_user['cellphone']); ?></td>
                            <td class="text-center"><?php echo e(OtherHelpers::total_flexi($flexi->user_id)); ?></td>
                            <td class="text-right"><?php echo e(number_format(BalanceHelper::flexi_cost($flexi->user_id),2)); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                    <tfoot>
                        <tr>
                            <th colspan="2">Total</th>
                            <th class="text-center"><?php echo e($total_flexi); ?></th>
                            <th class="text-right"><?php echo e(number_format($total_flexi_cost,2)); ?></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
