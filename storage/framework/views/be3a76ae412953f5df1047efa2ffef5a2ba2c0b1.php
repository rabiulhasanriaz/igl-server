...
<?php $__env->startSection('sender_operator_report_class','active'); ?>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-container">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background: #f8f8f8; padding: 15px; margin-bottom: 20px; border-radius: 4px;">
                <form method="GET" action="<?php echo e(route('admin.reports.sender-operator-report')); ?>" class="form-inline">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="form-group" style="width: 100%;">
                                ...
                                <input type="date" name="start_date" id="start_date" 
                                       ...
                                       value="<?php echo e(isset($start_date) ? $start_date : Carbon\Carbon::now()->subDays(30)->format('Y-m-d')); ?>">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="form-group" style="width: 100%;">
                                ...
                                <input type="date" name="end_date" id="end_date" 
                                       class="form-control" style="width: 100%;" 
                                       value="<?php echo e(isset($end_date) ? $end_date : Carbon\Carbon::now()->format('Y-m-d')); ?>">
                            </div>
                        </div>
                                ...
                                <select name="sender_id" id="sender_id" class="form-control" style="width: 100%;">
                                    ...
                                    <?php if(isset($senders)): ?>
                                        <?php $__currentLoopData = $senders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sender->id); ?>" <?php echo e(request('sender_id') == $sender->id ? 'selected' : ''); ?>>
                                                <?php echo e($sender->sir_sender_id); ?>
                                ...
                                <select name="operator_id" id="operator_id" class="form-control" style="width: 100%;">
                                    ...
                                    <?php if(isset($operators)): ?>
                                        <?php $__currentLoopData = $operators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $operator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($operator->id); ?>" <?php echo e(request('operator_id') == $operator->id ? 'selected' : ''); ?>>
                                                <?php echo e($operator->ope_operator_name); ?>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12" style="padding-top: 22px;">
                            <div class="form-group" style="width: 100%;">
                                ...
                                <a href="<?php echo e(route('admin.reports.sender-operator-report-export', request()->all())); ?>" 
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="well well-sm text-center" style="background: #e8f5e9; border-color: #4caf50;">
                            ...
                            <h3><?php echo e(isset($summary->total_messages) ? number_format($summary->total_messages) : 0); ?></h3>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="well well-sm text-center" style="background: #e3f2fd; border-color: #2196f3;">
                            <h4><i class="fa fa-tag"></i> Total Senders</h4>
                            <h3><?php echo e(isset($summary->total_senders) ? number_format($summary->total_senders) : 0); ?></h3>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="well well-sm text-center" style="background: #fce4ec; border-color: #f44336;">
                            ...
                            <h5 style="margin-top: 8px;">
                                <?php echo e(isset($start_date) ? Carbon\Carbon::parse($start_date)->format('d-M-Y') : Carbon\Carbon::now()->subDays(30)->format('d-M-Y')); ?> 
                                <i class="fa fa-arrow-right"></i> 
                                <?php echo e(isset($end_date) ? Carbon\Carbon::parse($end_date)->format('d-M-Y') : Carbon\Carbon::now()->format('d-M-Y')); ?>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 15px;">
                ...
                <table id="sender-operator-table" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <?php if(isset($senderReports) && count($senderReports) > 0): ?>
                            <?php $__currentLoopData = $senderReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $total_messages += $report->total_messages;
                                ?>
                                <tr>
                                    <td><?php echo e(++$sl); ?></td>
                                    <td><strong><?php echo e($report->sender_id); ?></strong></td>
                                    <td>
                                        <?php if($report->operator_name != 'N/A'): ?>
                                            <span class="label label-success"><?php echo e($report->operator_name); ?></span>
                                        <?php else: ?>
                                            <span class="label label-default">N/A</span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="text-center">
                                        <span class="badge badge-primary"><?php echo e(number_format($report->total_messages)); ?></span>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                    ...
                    <tfoot>
                        <tr style="background: #f5f5f5; font-weight: bold;">
                            ...
                            <th class="text-center"><?php echo e(number_format($total_messages)); ?></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <?php $__currentLoopData = $operatorSummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $operatorName => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="well well-sm" style="margin-bottom: 0; background: #f5f5f5;">
                                        ...
                                        <div class="progress" style="margin: 5px 0 0 0; height: 20px;">
                                            <div class="progress-bar progress-bar-success" 
                                                 style="width: <?php echo e($total_messages > 0 ? ($data['total_messages'] / $total_messages) * 100 : 0); ?>%;">
                                                <?php echo e(number_format($data['total_messages'])); ?>

                                            </div>
                                        </div>
                                        <small><?php echo e($data['count']); ?> Senders</small>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
