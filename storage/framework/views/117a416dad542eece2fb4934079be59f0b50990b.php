...
<?php $__env->startSection('main_content'); ?>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-container">
            ...
            <form action="<?php echo e(route('reseller.profile')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 center">
						...
						<span class="profile-picture">
							<img id="avatar" class="editable img-responsive" alt="Alex's Avatar"
                                 src="<?php echo e(OtherHelpers::user_logo(Auth::user()->userDetail->logo)); ?>" style="width: 100%;"/>
                            ...
                            <div class="profile-contact-links align-left">
                                ...
                                <span>
                                    <input type="text" style="height: 20px; margin-left: 10px;" name="facebookId"
                                           ...
                                           value="<?php echo e(Auth::user()->userDetail->facebookid); ?>"
                                ...
                                <span>
                                    <input type="text" style="height: 20px; margin-left: 10px;" name="website"
                                           class="input-sm" id="inputsm"
                                           value="<?php echo e(Auth::user()->userDetail->domain_name); ?>" placeholder="abc.com">
                                </span>
                                ...
                                <span>
                                    <input type="text" style="height: 20px; margin-left: 10px;" name="hotline"
                                           class="input-sm" id="inputsm" value="<?php echo e(Auth::user()->userDetail->hotline); ?>"
                                ...
                                <span>
                                    <input type="text" style="height: 20px; margin-left: 10px;" name="logout_url"
                                           class="input-sm" id="inputsm"
                                           value="<?php echo e((Auth::user()->userDetail->logout_url!=null)? Auth::user()->userDetail->logout_url:'http://'); ?>"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="col-xs-12 col-sm-4  col-md-4  col-lg-4 padding">
                                <h4 class="text-primary">Credit
                                    : <?php echo e(number_format(BalanceHelper::user_total_credit(Auth::user()->id), 2)); ?> ৳</h4>
                            </div>
                            <div class="col-xs-12 col-sm-4  col-md-4  col-lg-4 padding">
                                <h4 class="text-danger">Debit
                                    : <?php echo e(number_format(BalanceHelper::user_total_debit(Auth::user()->id), 2)); ?> ৳</h4>
                            </div>
                            <div class="col-xs-12 col-sm-4  col-md-4  col-lg-4 padding">
                                <h4 class="text-success">Balance
                                    : <?php echo e(number_format(BalanceHelper::user_available_balance(Auth::user()->id), 2)); ?>
                        ...
                        <div class="profile-user-info profile-user-info-striped">
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable" id="username"><?php echo e(Auth::user()->userDetail->name); ?></span>
                                    <span class="pull-right">
                                        <input type="text" name="name" class="input-sm"
                                               id="inputsm" placeholder="Name"
                                               value="<?php echo e(Auth::user()->userDetail->name); ?>"
                                               style="height: 25px;">
                                    </span>
                                </div>
                            </div>
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable" id="username"><?php echo e(Auth::user()->company_name); ?></span>
                                    <span class="pull-right">
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable" id="email"><?php echo e(Auth::user()->email); ?></span>
                                </div>
                            </div>
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable" id="mobile"><?php echo e(Auth::user()->cellphone); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    ...
                                    <?php echo e(Auth::user()->userDetail->address); ?>
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable"
                                          id="signup"><?php echo e(Auth::user()->created_at->format('Y-m-j h:i:s a')); ?></span>
                                </div>
                            </div>
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable" id="about"><?php echo e(Auth::user()->userDetail->designation); ?></span>
                                    <span class="pull-right">
                                        <input type="text"
                                               value="<?php echo e(Auth::user()->userDetail->designation); ?>"
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    ...
                                    <div class="image" style="float: left;">
                                        <img src="<?php echo e(OtherHelpers::user_logo(Auth::user()->userDetail->logo)); ?>"
                                             alt="<?php echo e(Auth::user()->name); ?>" style="max-width: 60px;">
                                    </div>
                                </div>
                            </div>
