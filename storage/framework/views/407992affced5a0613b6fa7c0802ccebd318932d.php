...
<div style="margin-top: -10px; margin-bottom: 15px;">
    <ul class="breadcrumb" style="background: transparent; padding-left: 0; margin-bottom: 10px;">
        <li>
            ...
            <a href="<?php echo e(route('admin.index')); ?>" style="color: #438EB9;">Home</a>
        </li>
...
<div class="row">
    <div class="col-md-3 col-sm-6">
        <div class="stat-box">
            ...
            <div class="stat-info"><small>Active Users</small><h2><?php echo e($data['active_user']); ?></h2></div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6">
        <div class="stat-box">
            <div class="stat-icon" style="color: #e74c3c;"><i class="fa fa-lock"></i></div>
            <div class="stat-info"><small>Suspended</small><h2><?php echo e($data['suspend_user']); ?></h2></div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6">
        <div class="stat-box">
            <div class="stat-icon"><i class="fa fa-paper-plane-o" style="color:#438EB9"></i></div>
            <div class="stat-info"><small><?php echo e(\Carbon\Carbon::now()->format('M')); ?> Volume</small><h2><?php echo e($data['last_month_sms']); ?></h2></div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6">
        <div class="stat-box" style="border-bottom: 2px solid #2c3e50;">
            ...
            <div class="stat-info"><small>Lifetime Total</small><h2><?php echo e($data['total_sms']); ?></h2></div>
        </div>
    </div>
</div>
    ...
    <div class="col-md-4">
        <div class="main-card highlight-card">
            ...
            <table class="table table-premium">
                ...
                <tbody>
                    <?php $__currentLoopData = $data['monthly_sms']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $monthly_sms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td style="font-weight: 600; color: #34495e;"><i class="fa fa-calendar-o" style="color:#438EB9"></i> <?php echo e(date("M Y", mktime(0,0,0,$monthly_sms->month,1,$monthly_sms->year))); ?></td>
                        <td class="text-right"><span class="badge" style="background:#438EB9"><?php echo e(number_format($monthly_sms->total_sms)); ?></span></td>
                    </tr>
        ...
        <div class="main-card" style="margin-top: 15px;">
            ...
            <table class="table table-condensed mb-0" style="font-size: 13px;">
                <tbody>
                    <?php $__currentLoopData = $data['ans_balances']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opName => $balance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php 
                    ...
                    <tr>
                        <td style="padding: 10px 12px;">
                            <span class="op-icon <?php echo e($colorClass); ?>"><i class="fa <?php echo e($iconClass); ?>"></i></span>
                            <strong><?php echo e($opName); ?></strong>
                        </td>
                        <td class="text-right font-weight-bold" style="color:#438EB9"><?php echo e($balance['availableBalance'] ?? '0.00'); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
...
$(document).ready(function() {
    ...
    function initCharts() {
        // Monthly Chart
        $.get("<?php echo e(route('admin.monthly-sms-count')); ?>", function(res) {
            if (res.success) {
        ...
        // Daily Chart
        $.get("<?php echo e(route('admin.daily-sms-data')); ?>", function(data) {
        ...
        // Segment Chart
        $.get("<?php echo e(route('admin.today-sms-counts')); ?>", function(res) {
    ...
    function refreshLiveStats() {
        ...
        $.ajax({ url: "<?php echo e(route('admin.data-count')); ?>", success: d => $('#immediateCount').html(d) });
        $.ajax({ url: "<?php echo e(route('admin.data-cost')); ?>", success: d => $('#immediateCost').html(d) });
        
        // Scheduled Queue Count & Cost (need to add these routes)
        $.ajax({ url: "<?php echo e(route('admin.scheduled-count')); ?>", success: d => $('#scheduledCount').html(d) });
        $.ajax({ url: "<?php echo e(route('admin.scheduled-cost')); ?>", success: d => $('#scheduledCost').html(d) });
    }
