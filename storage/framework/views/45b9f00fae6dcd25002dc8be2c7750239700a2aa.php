<script>
    ...
    function checkEmailExistence(email) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(url('/ajax/checkEmailExistence')); ?>",
            data: {email: email},
    ...
    function checkPhoneExistence(phone) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(url('/ajax/checkPhoneExistence')); ?>",
            data: {phone: phone},
            success: function (data) {
                if (data == 'valid') {
                    $(".invalid-phone").text('');
    ...
    function checkEmployeePhoneExistence(phone) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(url('/ajax/checkEmployeePhoneExistence')); ?>",
            data: {phone: phone},
            success: function (data) {
                if (data == 'valid') {
                    $(".invalid-phone").text('');
    ...
    function checkEmailExistenceForUpdate(email, user_id){
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(url('/ajax/checkEmailExistenceForUpdate')); ?>",
    ...
    function checkPhoneExistenceForUpdate(phone, user_id, e) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(url('/ajax/checkPhoneExistenceForUpdate')); ?>",
