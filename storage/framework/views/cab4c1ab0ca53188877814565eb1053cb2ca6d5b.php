...
<?php $__env->startSection('virtual_number_list_menu_class', 'active'); ?>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding bg-container">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="virtual-number-table">
                        ...
                        <tbody>
                            <?php ($serial=1); ?>
                            <?php $__currentLoopData = $virtualNumbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $virtualNumber): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($serial++); ?></td>
                                    <td><?php echo e($virtualNumber->operator->ope_operator_name); ?></td>
                                    <td><?php echo e($virtualNumber->created_at->format('j M, Y')); ?></td>
                                    <td><?php echo e($virtualNumber->sivn_name); ?></td>
                                    <td><?php echo e($virtualNumber->sivn_load_amount); ?></td>
                                    <td><?php echo e($virtualNumber->sivn_api_user_name); ?></td>
                                    <td>
                                        <?php echo e($virtualNumber->sivn_number); ?> ->
                                        <span style="color: red; background-color: #ddd; border: 2px solid green; padding: 0px 8px; font-weight: bold;">
                                            <?php echo e(optional($virtualNumber->{strtolower($virtualNumber->operator->ope_operator_name ?? '')})->count() ?? 0); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <a href="javascript:void(0)" onclick="viewSystem(<?php echo e($virtualNumber->id); ?>)" class="label label-info">
                                            View System
                                        </a>
                                    </td>
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="green" href="javascript:void(0)" onclick="checkBalance(<?php echo e($virtualNumber->id); ?>, '<?php echo e(addslashes($virtualNumber->sivn_name)); ?>', '<?php echo e(addslashes($virtualNumber->sivn_number)); ?>')" title="Balance">
                                                <i class="ace-icon glyphicon glyphicon-usd"></i>
                                            </a>
                                            <a class="green" href="<?php echo e(route('admin.virtualNumber.edit', $virtualNumber->id)); ?>" title="Edit">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>
                                            <a class="red" onclick="return confirm('Are you sure to delete this?')" href="<?php echo e(route('admin.virtualNumber.delete', $virtualNumber->id)); ?>" title="Delete">
