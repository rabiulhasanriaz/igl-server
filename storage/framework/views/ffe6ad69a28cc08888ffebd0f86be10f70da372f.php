...
<?php $__env->startSection('main_content'); ?>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-container">
            ...
            <form action="<?php echo e(route('user.profile')); ?>" method="post" enctype="multipart/form-data" id="profile_form">
                <?php echo csrf_field(); ?>
                <div id="user-profile-1" class="user-profile row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="col-xs-12 col-sm-4  col-md-4  col-lg-4 padding">
                                <h4 class="text-primary">Credit
                                    : <?php echo e(number_format(BalanceHelper::user_total_credit(Auth::id()),2)); ?> ৳</h4>
                            </div>
                            <div class="col-xs-12 col-sm-4  col-md-4  col-lg-4 padding">
                                <h4 class="text-danger">Debit
                                    : <?php echo e(number_format(BalanceHelper::user_total_debit(Auth::id()),2)); ?> ৳</h4>
                            </div>
                            <div class="col-xs-12 col-sm-4  col-md-4  col-lg-4 padding">
                                <h4 class="text-success">Balance
                                    : <?php echo e(number_format(BalanceHelper::user_available_balance(Auth::id()),2)); ?> ৳</h4>
                            </div>
                        </div>
                        <br>
                                ...
                                <div class="profile-info-value">
                                    <label class="switch">
                                        <input type="checkbox" name="otp_check" id="otp_toggle"
                                            <?php echo e(optional(Auth::user()->userDetail)->otp_check == 1 ? 'checked' : ''); ?>>
                                        <span class="slider round"></span>
                                    </label>
                                    <span style="margin-left: 10px; font-weight: bold;" id="otp_status_text">
                                        <?php echo e(optional(Auth::user()->userDetail)->otp_check == 1 ? '🔴 OTP Disabled' : '🟢 OTP Required'); ?>
                        ...
                        <div id="otp_warning_message" class="alert alert-danger" style="display: <?php echo e(optional(Auth::user()->userDetail)->otp_check == 1 ? 'block' : 'none'); ?>; margin-top: 10px;">
                        ...
                        <div class="profile-user-info profile-user-info-striped">
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable" id="signup"><?php echo e(Auth::user()->created_at->format('Y-m-j h:i:s a')); ?></span>
                                </div>
                            </div>
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    ...
                                    <span class="pull-right">
                                        <input type="text" value="<?php echo e(Auth::user()->userDetail->designation); ?>"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function autoSaveOTP(otpValue) {
                ...
                fetch('<?php echo e(route("user.update-otp")); ?>', {
                    method: 'POST',
                    headers: {
