...
<?php $__env->startSection('page_location'); ?>
    <ul class="breadcrumb">
        ...
        <li class="active">Edit Whitelisted IP</li>
    </ul>
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form action="<?php echo e(route('admin.whitelistedIp.update', $user->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="user_id" id="user_id" class="form-control select2" required>
                                    ...
                                    <option value="<?php echo e($u->id); ?>" <?php echo e($user->id == $u->id ? 'selected' : ''); ?>>
                                        <?php echo e($u->cellphone); ?> - <?php echo e($u->company_name); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="<?php echo e($user->userDetail->white_listed_ip ?? ''); ?>"
                                       placeholder="e.g., 192.168.1.1 or 103.86.193.27,59.152.5.62">
                                
                                <?php if($user->userDetail && $user->userDetail->white_listed_ip): ?>
                                    <div class="alert alert-info" style="margin-top: 10px;">
                                        <strong>Current:</strong> <code><?php echo e($user->userDetail->white_listed_ip); ?></code>
                                    </div>
                                <?php else: ?>
                                    <div class="alert alert-warning" style="margin-top: 10px;">
                                        <strong>⚠ No IP restriction</strong> (all IPs allowed)
                                    </div>
                                <?php endif; ?>
