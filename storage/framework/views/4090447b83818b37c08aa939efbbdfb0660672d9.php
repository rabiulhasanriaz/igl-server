...
<?php $__env->startSection('flexiload_trx_class', 'active'); ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <ul class="list-group list-inline">
                <li class="list-group-item list-group-item-warning">Airtel =>&nbsp;
                    <span class="badge badge-primary badge-pill"><?php echo e($airtel); ?></span>
                </li>
                <li class="list-group-item list-group-item-warning">Banglalink =>&nbsp;
                    <span class="badge badge-primary badge-pill"><?php echo e($bl); ?></span>
                </li>
                <li class="list-group-item list-group-item-warning">GrameenPhone =>&nbsp;
                    <span class="badge badge-primary badge-pill"><?php echo e($gp); ?></span>
                </li>
                <li class="list-group-item list-group-item-warning">Robi =>&nbsp;
                    <span class="badge badge-primary badge-pill"><?php echo e($robi); ?></span>
                </li>
                <li class="list-group-item list-group-item-warning">Teletalk =>&nbsp;
                    <span class="badge badge-primary badge-pill"><?php echo e($tt); ?></span>
                </li>
                <li class="list-group-item list-group-item-danger">Total =>&nbsp;
                    <span class="badge badge-danger badge-pill"><?php echo e($total); ?></span>
                </li>
            </ul>
            ...
            <table class="table table-striped table-bordered table-hover" id="reseller_list">
                ...
                <tbody>
                <?php ($serial=1); ?>
                <?php $__currentLoopData = $load_trx; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="trx_pending[]" value="<?php echo e($trx->id); ?>" id="">
                                <label class="form-check-label" for="defaultCheck1">
                                </label>
                            </div>
                        </form>
                        ...
                        <td>
                            <?php echo e($trx->trx_user['company_name']); ?>

                        </td>
                        <td><?php echo e($trx->created_at); ?></td>
                        <td onclick="copy('<?php echo e(substr($trx->targeted_number,3,10)); ?>')">
                            <?php echo e(substr_replace($trx->targeted_number,' ',3,-strlen($trx->targeted_number))); ?>

                        </td>
                        <td class="text-right"><?php echo e(number_format($trx->campaign_price,2)); ?></td>
                        <td>
                            <form action="<?php echo e(route('admin.flexiload.update-trx-id',$trx->id)); ?>" method="post" style="display: inline;">
                                <?php echo csrf_field(); ?>
                       ...
                       <td>
                           <form action="<?php echo e(route('admin.flexiload.reload-load', $trx->id)); ?>" method="get">
                            <?php echo csrf_field(); ?>  
                            <label class="radio-inline">
                                <input type="radio" name="num_type" id="type" value="1" <?php echo e(($trx->number_type == 1)? 'checked' : ''); ?>>Prepaid
                              </label>
                              <label class="radio-inline">
                                <input type="radio" name="num_type" id="type" value="2" <?php echo e(($trx->number_type == 2)? 'checked' : ''); ?>>Postpaid
                              </label>
                              <label class="radio-inline">
                                <input type="radio" name="num_type" id="type" value="3" <?php echo e(($trx->number_type == 3)? 'checked' : ''); ?>>Skitto
                              </label>
