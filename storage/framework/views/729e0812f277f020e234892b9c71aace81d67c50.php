...
<?php $__env->startSection('load_archieve_history_menu_class','active'); ?>
...
<div class="row">
	...
	<div id="my-modal" class="modal fade" tabindex="-1" style="display: none;">
		...
		<form class="form-inline" action="<?php echo e(route('user.flexiload.history_archieve')); ?>" method="get" >
				...
				<table id="dynamic-table" class="table table-striped table-bordered table-hover">
					...
					<?php $__currentLoopData = $loads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $load): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<tr>
							...
							<td>
							    <label>
							        <a href="#my-modal" onclick="show_campaign_details('<?php echo e($load->campaign_id); ?>')"
							           role="button" data-toggle="modal"
							           class="btn-none-edit CampaignId_one"> View </a>
							    </label>
								|
							    <label>
							        <a href="<?php echo e(route('user.flexiload.downloadFlexiReport', ['campaign_id'=>$load->campaign_id])); ?>" target="_blank" role="button" data-toggle="modal" class="btn-none-edit CampaignId_one"> Download </a>
							    </label>
							</td>
						</tr>
