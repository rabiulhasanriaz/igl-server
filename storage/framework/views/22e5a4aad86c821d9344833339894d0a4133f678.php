...
<?php $__env->startSection('non_whitelisted_menu_class', 'active'); ?>
        ...
        <table id="non-whitelisted-table" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($user->cellphone ?? 'N/A'); ?></a></td>
                    <td><?php echo e($user->company_name ?? 'N/A'); ?></a></td>
                    <td><?php echo e($user->email ?? 'N/A'); ?></a></td>
                    <td>
                    ...
                    <td>
                        <?php if(($user->today_count ?? 0) > 0): ?>
                            <span class="label label-warning">
                                <i class="ace-icon fa fa-send"></i> <?php echo e($user->today_count); ?> SMS
                            </span>
                        <?php else: ?>
                    ...
                    <td>
                        <?php if(($user->remaining ?? 50) > 0): ?>
                            <span class="label label-success">
                                <i class="ace-icon fa fa-hourglass-half"></i> <?php echo e($user->remaining); ?> Left
                            </span>
                        <?php else: ?>
                    ...
                    <td>
                        <div class="hidden-sm hidden-xs action-buttons">
                            <a class="green" href="<?php echo e(route('admin.whitelistedIp.edit', $user->id)); ?>" title="Add Whitelisted IP">
                                <i class="ace-icon fa fa-shield bigger-130"></i>
                            </a>
                            <a class="blue" href="javascript:void(0)" onclick="viewDailyUsage(<?php echo e($user->id); ?>)" title="View Daily Usage">
...
function viewDailyUsage(userId) {
    ...
    $.ajax({
        url: '<?php echo e(route("admin.whitelistedIp.daily_usage", "")); ?>/' + userId,
        type: 'GET',
        dataType: 'json',
