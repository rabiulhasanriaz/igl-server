<?php $__env->startSection('api_comission_class','active'); ?>
<?php $__env->startSection('page_location'); ?>
    <ul class="breadcrumb">
        ...
        <li class="active">API Permission Set</li>
    </ul><!-- /.breadcrumb -->
...
<div class="clearfix">
    <div class="pull-right">
        <a href="<?php echo e(route('admin.api-monitor')); ?>" class="btn btn-sm btn-primary">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <table class="table table-striped table-bordered table-hover" id="reseller_list">
                ...
                <tr>
                    ...
                    <td>
                        <?php if($user->userDetail->api_permission == 1): ?>
                            <span class="text-success">Active</span>
                        <?php elseif($user->userDetail->api_permission == 2): ?>
                        <span class="text-danger">Suspend</span>
                        <?php endif; ?>
                    </td>
                    <td>
                        <a href="<?php echo e(route('admin.api-permission-active', $user->id)); ?>" onclick="return confirm('Are you sure?')" style="color: green;">Active</a>
                        |
                        <a href="<?php echo e(route('admin.api-permission-suspend', $user->id)); ?>" onclick="return confirm('Are you sure?')" style="color: red;">Suspend</a>
                    </td>
                </tr>
