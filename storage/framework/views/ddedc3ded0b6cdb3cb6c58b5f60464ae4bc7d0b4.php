...
<html lang="en">
	<head>
        ...
        <link rel="icon" href="<?php echo e(OtherHelpers::website_logo()); ?>" type="/favicon.ico">
	...
	<?php echo $__env->yieldContent('custom_style'); ?>
		...
		<link rel="stylesheet" href="<?php echo e(asset('assets')); ?>/css/custom.css?v=1.0.1" />
...
<div id="loading">
	...
	<?php echo $__env->make('user.partials.header', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
