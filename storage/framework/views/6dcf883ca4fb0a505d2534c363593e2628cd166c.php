...
<?php $__env->startSection('bulk_flexiload_make_menu_class', 'active'); ?>
...
<?php $__env->startSection('main_content'); ?>
    ...
    <ul>
        <li style="font-size: 15px;"><kbd style="background-color: #cc3737;">The Limit of Balance for Robi/Airtel Number is not more than Tk 5000</kbd></li>
    </ul>
    ...
    <div class="row">
        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
            ...
            <div class="" style="">
                ...
                <form action="<?php echo e(route('user.flexiload.bulkLoadForm')); ?>" id="dynamic_sms_send1" method="post" class="form-horizontal"
        ...
        <div class="col-sm-5 col-md-5">
            <table class="table table-bordered table-striped">
                <div>
                    <ul style="font-weight: bold; color: green">
                        ...
                        <li>Number type should be only 1,2 or 3. 1 for prepaid, 2 for postpaid and 3 for Skitto.</li>
                    </ul>    
                </div> 
            ...
            <p style="color: green;">Download a <a style="font-weight: bold;" href="<?php echo e(asset('assets/bulkLoadDemo.xlsx')); ?>"> Demo Excel</a></p>
        </div>
    </div><!-- /.row -->
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('custom_script'); ?>
    ...
    <script src="<?php echo e(asset('assets')); ?>/js/ajax_send_sms.js?v=1.0"></script>
    ...
    <script type="text/javascript">
        ...
        $('#click1').click(function () {
            valid_dynamic_flexiload_file('dynamic_sms_send1', '<?php echo e(route('user.flexiload.checkDynamicFile')); ?>');
        });
