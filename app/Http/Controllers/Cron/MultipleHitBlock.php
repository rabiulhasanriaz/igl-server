            ...
            foreach ($getNonMaskingSmsCampaigns as $nonMaskingSmsCampaign) {
                ...
                foreach ($getSms50OfSameCampaignIds as $sms50Details) {
                    ...
                    if (substr($sender_id, 0, 3) == '018') {
                        ...
                        $xml_response = \SmsHelper::ra_non_masking_infozillion_sms('iglweb_longcode', 'Dhaka@2021', $nonMaskingSmsCampaign->scp_message, $numbers, $sender_id, '01844532631', $apiCentral, $transType, $msgType);
                        // dd($xml_response);
                        ...
                        if ($responseCode == '9001') {
                            ...
                            // foreach ($xml_response as $smsReport) {
                                $dataForInsert = [
                                    ...
                                    'created_at' => $checkedSms->created_at,
                                    'updated_at' => $checkedSms->updated_at,
                                    'sct_delivery_report' => ($responseCode == '9000' && $mnoResponseCode == '1000') ? 'DELIVERED' : 'PENDING',
