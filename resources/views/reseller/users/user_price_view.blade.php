...
@section('page_location')
    <ul class="breadcrumb">
        ...
        <li>
            <a href="{{ route('reseller.user.index') }}">User List</a>
        </li>
...
@section('page_header')
    <h1>
        ...
        <small>
            ...
            Update Rates for {{ $user->userDetail->company_name }}
        </small>
    </h1>
@endsection
            ...
            <div class="widget-box transparent">
                <div class="widget-header">
                    <h4 class="widget-title lighter">
                        ...
                        {{ $user->userDetail->company_name }} - Rate Management
                    </h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="label label-info arrowed-in-right">
                                                        BDT: {{ $smsRate->asr_masking }} / {{ $smsRate->asr_nonmasking }}
                                                    </span>
                                                </td>
                                                <td>
                                                    ...
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="text" name="masking_price"
                                                               form="form_{{$smsRate->id}}"
                                                               class="form-control" value="{{ $smsRate->asr_masking }}" required>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="text" name="non_masking_price"
                                                               form="form_{{$smsRate->id}}"
                                                               class="form-control" value="{{ $smsRate->asr_nonmasking }}" required>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="text" name="non_masking_iptsp_price"
                                                               form="form_{{$smsRate->id}}"
                                                               class="form-control" value="{{ $smsRate->asr_nonmasking_iptsp }}">
                                                    </div>
                                                </td>
                                                <td>
                                                    <button type="button" onclick="submitRateForm('form_{{$smsRate->id}}')" 
                            ...
                            <div id="profile-tab" class="tab-pane">
                                <div class="profile-user-info profile-user-info-striped">
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span>{{ $user->userDetail->designation }}</span>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        function submitBulkUpdate() {
            ...
            if(confirm('Are you sure you want to update all prices at once? This action cannot be undone.')) {
                ...
                // Submit via AJAX
                $.ajax({
                    url: "{{ route('reseller.user.bulk-update') }}",
                    type: "POST",
                    data: bulkData,
