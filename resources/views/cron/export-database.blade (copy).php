<?php
    ...
    if($_SERVER['SERVER_NAME'] != 'localhost') {
        die("Your PC will be hacked soon.... be carefull!!!!");
        // die("বেয়াদব কোথাকার , এখানে কি করিস  !!! যা নিজের কাজে  মনোযোগ দে .....");
        exit();
    }
    ...
    echo "The Database will be exported between 01:00 AM and 01:30 AM<br>";
    echo $_SESSION['export_database'];

    $try_start_time = 0100; // This value always should be bellow 59 of second place
    $try_end_time = $try_start_time+30;
