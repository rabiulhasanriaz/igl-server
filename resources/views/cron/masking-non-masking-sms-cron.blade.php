...
@endphp
            ...
            @if(!empty($returnError['errorNotify']))
                <div class="alert alert-danger cron-error mb-4" role="alert">
                    ...
                    <strong>Error:</strong> {{ $returnError['errorNotify'] }}
                </div>
            @endif

            @if(!empty($returnError['gpError']))
                <div class="alert alert-danger cron-error mb-3" role="alert">
                    <strong>GP Error:</strong> {{ $returnError['gpError'] }}
                </div>
            @endif

            @if(!empty($returnError['blError']))
                <div class="alert alert-danger cron-error mb-3" role="alert">
                    <strong>Banglalink Error:</strong> {{ $returnError['blError'] }}
                </div>
            @endif

            @if(!empty($returnError['robiAirtelError']))
                <div class="alert alert-danger cron-error mb-3" role="alert">
                    <strong>Robi/Airtel Error:</strong> {{ $returnError['robiAirtelError'] }}
                </div>
            @endif

            @if(!empty($returnError['ttError']))
                <div class="alert alert-danger cron-error mb-3" role="alert">
                    <strong>Teletalk Error:</strong> {{ $returnError['ttError'] }}
                </div>
            @endif
                            ...
                            <div class="list-group list-group-flush">
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        ...
                                        <span class="count-badge">{{ shortSmsStatus($returnData['robi_airtel'] ?? 'N/A') }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        ...
                                        <span class="count-badge">{{ shortSmsStatus($returnData['banglalink'] ?? 'N/A') }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        ...
                                        <span class="count-badge">{{ shortSmsStatus($returnData['gp'] ?? 'N/A') }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        ...
                                        <span class="count-badge">{{ shortSmsStatus($returnData['teletalk'] ?? 'N/A') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="list-group list-group-flush">
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        ...
                                        <span class="count-badge">{{ shortSmsStatus($retTextRobi ?? 'N/A') }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        ...
                                        <span class="count-badge">{{ shortSmsStatus($retTextGp ?? 'N/A') }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        ...
                                        <span class="count-badge">{{ shortSmsStatus($retTextBl ?? 'N/A') }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        ...
                                        <span class="count-badge">{{ shortSmsStatus($retTextIptsp ?? 'N/A') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
