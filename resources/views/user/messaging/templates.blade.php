    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="tab-pane fade active in" id="recipient">
                <form action="{{ route('user.template.store') }}" method="post" id="addTemplateForm">
                    @csrf
            ...
            <div class="tab-pane fade active in" id="recipientEdit">
                <form action="{{ route('user.template.update') }}" method="post" id="editTemplateForm">
                    @csrf
                ...
                @foreach($templates as $template)
                    <tr class="d-flex">
                        ...
                        <td>
                            ...
                            | 
                            <a href="{{ route('user.template.delete', $template->id) }}" 
