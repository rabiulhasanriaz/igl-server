...
@section('dynamic_messaging_menu_class','open')
@section('send_sms_modem_class','active')
                ...
                <div class="tab-content">
                    ...
                    <div id="group-contact-content" class="tab-pane fade">
                     ...
                     <div id="dynamic-sms-content" class="tab-pane fade">
                        @include('user.messaging.sms_modem.smspart.dynamic_sms_content')
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background: #f9f9f9; color: red;">
                        <h3 class="text-danger">Note for Route 2 SMS</h3>
                        <ul>
...
@section('custom_script')
    ...
    $("#file_preview_content").hide();
        ...
        $('#click1').click(function () {
            valid_dynamic_sms_file('dynamic_sms_send', '{{ route('user.dynamic-sms.checkDynamicFileModem') }}');
        });
        ...
        sms_send_form_submit('dynamic_sms_send', '{{ route('user.dynamic-sms.storeDynamicSmsModem') }}');
