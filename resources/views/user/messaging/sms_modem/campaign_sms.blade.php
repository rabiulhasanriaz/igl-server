        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 padding">
                ...
                <div class="tab-pane fade active in" id="campaign_sms_send">
                    <form action="{{ route('user.dynamic-sms.storeCampaignSms') }}" id="campaign_sms_send_form" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        @csrf
...
@section('custom_script')
    ...
    <script type="text/javascript">
        ...
        sms_send_form_submit('campaign_sms_send_form', '{{ route('user.dynamic-sms.storeCampaignSms') }}');
    </script>
@endsection
