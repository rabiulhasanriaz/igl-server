...
@section('api_progress_menu_class','active')
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="widget-box" style="margin-bottom: 20px; background: #fff; border: 1px solid #ccc; border-radius: 4px;">
			...
			<div class="widget-body" style="padding: 15px;">
				@if(Auth::user()->userDetail->white_listed_ip)
					<div class="alert alert-info" style="margin-bottom: 0;">
						<i class="ace-icon fa fa-info-circle"></i>
						<strong>Current White Listed IP:</strong> 
						<code>{{ Auth::user()->userDetail->white_listed_ip }}</code>
						<br>
		...
		{{-- Form for changing API Key - using direct URL --}}
		<form action="{{ url('/developerApi/change') }}" method="POST" enctype="multipart/form-data">
			@csrf
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 api-urltitle-contain">
			 ...
			 <span>http://{{ $domain_url }}/api/v1/send?api_key=(API KEY)&contacts=(NUMBER)&senderid=(Approved Sender ID)&msg=(Message Content)</span>
		</div>
	</div>
	...
	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 api-urltitle-bottom">
				<br>
				<strong>API URL :</strong>  http://{{  $domain_url }}/api/v1/balance?api_key=(API KEY) <br>
				<strong>API KEY :</strong>  Your API Key (<b> {{ Auth::user()->userDetail->api_key }} </b>)
			</div>
		</div><!-- /.col -->
	</div>
