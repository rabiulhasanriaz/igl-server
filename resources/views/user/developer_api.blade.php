...
@section('developer_api_progress_menu_class','active')
...
<div class="row">
  ...
  <div class="alert alert-info">
                        <strong>Your Current API Key:</strong> {{ Auth::user()->userDetail->api_key }}
                        <br>
                        <strong>Sample CURL Request:</strong>
                        <pre>curl -X GET "http://{{  $domain_url }}/api/v1/balance?api_key={{ Auth::user()->userDetail->api_key }}"</pre>
                    </div>
                ...
                <div class="widget-main">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <pre>http://{{  $domain_url }}/api/v1/send</pre>
                            ...
                            <pre>GET http://{{  $domain_url }}/api/v1/send?api_key=(API KEY)&contacts=(NUMBER)&senderid=(Approved Sender ID)&msg=(Message Content)</pre>
                            
                            <h4>POST Request Example</h4>
                            <pre>POST http://{{  $domain_url }}/api/v1/send
                ...
                <div class="widget-main">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h4>GET Request Example</h4>
                            <pre>GET http://{{  $domain_url }}/api/v1/send-load?api_key=(API KEY)&pin=(Your Secret Pin)&number=(NUMBER)&amount=(Amount)&number_type=(Prepaid/Postpaid)&operator=(Number Operator)</pre>
                            
                            <h4>POST Request Example</h4>
                            <pre>POST http://{{  $domain_url }}/api/v1/send-load 
                                Content-Type: application/x-www-form-urlencoded 
                ...
                <div class="widget-main">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <pre>http://{{  $domain_url }}/api/v1/sms-campaign-report</pre>
                            ...
                            <h4>GET Request Example</h4>
                            <pre>GET http://{{  $domain_url }}/api/v1/sms-campaign-report?api_key={{ Auth::user()->userDetail->api_key }}&campaign_id=123456789012345</pre>

                            <h4>GET Request Example With Contact Filter</h4>
                            <pre>GET http://{{  $domain_url }}/api/v1/sms-campaign-report?api_key={{ Auth::user()->userDetail->api_key }}&campaign_id=123456789012345&contacts=88017XXXXXXXX,88019XXXXXXXX</pre>

                            <h4>POST Request Example</h4>
                            <pre>POST http://{{  $domain_url }}/api/v1/sms-campaign-report
Content-Type: application/x-www-form-urlencoded

api_key={{ Auth::user()->userDetail->api_key }}&campaign_id=123456789012345</pre>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>The API requires an <code>api_key</code> to authenticate requests. Your API key is: 
                        <strong>{{ Auth::user()->userDetail->api_key }}</strong></p>
                    ...
                    <h4>GET Request Example</h4>
                    <pre>GET http://{{  $domain_url }}/api/v1/balance?api_key={{ Auth::user()->userDetail->api_key }}</pre>
