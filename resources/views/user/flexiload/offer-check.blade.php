...
@section('load_make_check_class','active')
        ...
        <div class="widget-box widget-color-blue">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form action="{{ url('offer-check') }}" method="POST" class="form-horizontal">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="operator" id="operator" class="form-control" required>
                                    ...
                                    <option value="grameen" {{ old('operator') == 'grameen' ? 'selected' : '' }}>Grameenphone</option>
                                    <option value="rb" {{ old('operator') == 'rb' ? 'selected' : '' }}>Robi</option>
                                    <option value="at" {{ old('operator') == 'at' ? 'selected' : '' }}>Airtel</option>
                                    <option value="bl" {{ old('operator') == 'bl' ? 'selected' : '' }}>Banglalink</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="number" name="number" value="{{ old('number') }}" class="form-control phone-input-large" placeholder="e.g. 017xxxxxxxx" required>
                            </div>
                        </div>
...
@if(isset($apiResponse) || isset($error))
@php
...
<div class="row mt-4">
    <div class="col-xs-12">
        <div class="widget-box widget-color-green2">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    @if(isset($request) && $request->has('number') && $request->has('operator') && $request->has('amount'))
                        ...
                        <div class="row text-center">
                            <div class="col-md-4 col-sm-4 col-xs-4">
                                ...
                                <span class="badge operator-badge-lg" id="operator-badge">
                                    @if($request->operator == 'grameen') GP
                                    @elseif($request->operator == 'rb') Robi
                                    @elseif($request->operator == 'at') Airtel
                                    @elseif($request->operator == 'bl') BL
                                    @elseif($request->operator == 'teletalk') TT
                                    @else {{ ucfirst($request->operator) }}
                                    @endif
                                </span>
                            </div>
                            <div class="col-md-4 col-sm-4 col-xs-4">
                                <small><strong>Phone Number:</strong></small><br>
                                <span class="phone-number-large">{{ $request->number }}</span>
                            </div>
                            <div class="col-md-4 col-sm-4 col-xs-4">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <div class="alert alert-info text-center py-2 mb-3" id="filter-status">
                                        <i class="fa fa-filter"></i> Showing all {{ $offersCount }} offers
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="offers-grid-8-col">
                            <div class="offers-container-8" id="offers-container">
                                @foreach($offers as $offer)
                                    ...
                                    <div class="offer-card-8-col offer-item {{ $packageTypesString }}" 
                                         data-filter-types="{{ $dataFilterTypes }}"
                                         data-30days="{{ $is30Days ? 'yes' : 'no' }}"
                                         data-7days="{{ $is7Days ? 'yes' : 'no' }}"
                                         data-data="{{ $hasData ? 'yes' : 'no' }}"
                                         data-minutes="{{ $hasMinutes ? 'yes' : 'no' }}"
                                         data-combo="{{ $hasCombo ? 'yes' : 'no' }}"
                                         data-social="{{ $hasSocial ? 'yes' : 'no' }}"
                                         data-streaming="{{ $hasStreaming ? 'yes' : 'no' }}"
                                         data-unlimited="{{ $hasUnlimited ? 'yes' : 'no' }}">
...
>
                                        ...
                                        <div class="offer-content-8-col">
                                            <h6 class="offer-summary-8-col" title="{{ $cleanSummary }}">
                                                {{ $cleanSummary }}
                                                @if($isHighlighted)
                                        ...
                                        <div class="offer-price-8-col">
                                            <div class="price-display-8-col">
                                                <span class="price-amount-8-col">{{ $offerAmount }}</span>
                                        ...
                                        <div class="offer-footer-8-col">
                                            <button type="button" 
                                                    ...
                                                    data-amount="{{ $offerAmount }}"
                                                    data-ussd="{{ $offerUssd }}"
                                                    data-summary="{{ $cleanSummary }}"
                                                    data-validity="{{ $offerValidity }}"
                    ...
                    @elseif(isset($apiResponse))
                        <div class="alert alert-info text-center py-3">
                            ...
                            @else
                                ...
                                @if(env('APP_DEBUG'))
                                    <br><small>Available response keys: {{ implode(', ', $responseKeys) }}</small>
                                @endif
                            @endif
                        </div>
                    @endif
...
<div class="modal fade" id="buyOfferModal" tabindex="-1" role="dialog" aria-labelledby="offerModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('offer-buy') }}" method="post" id="offerPurchaseForm">
                @csrf
