...
<div>
    <img src="{{ asset('assets/uploads/login_bg.png') }}" 
                        ...
                        <div class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    {{-- FORM --}}
                                    <form id="otpForm" action="{{ route('auth.otp.check') }}" method="POST">
                                        @csrf
                                    ...
                                    {{-- RESEND BUTTON - Hidden initially, shows after countdown expires --}}
                               ...
                               <div class="toolbar center">
                                    <a href="{{ route('auth.login') }}" class="back-to-login-link" style="color: #000000;">
...
<script>
    ...
    let expireTime = '{{ session('otp_expire') }}';
