		...
		<tbody>
			...
			@foreach( $transactions as $date => $data )
				...
				<tr>
                    ...
                    <td style="text-align: right;">{{ number_format($total_sms,2) }}</td>
