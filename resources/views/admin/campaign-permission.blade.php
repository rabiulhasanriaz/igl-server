...
@section('campaign_permission_class','active')
@section('page_location')
    <ul class="breadcrumb">
        ...
        <li class="active">Campaign Permission Set</li>
    </ul><!-- /.breadcrumb -->
@endsection
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <table class="table table-striped table-bordered table-hover" id="reseller_list">
                ...
                <tr>
                    ...
                    <td>{{ $user->email }}</td>
                    <td>
                        @if ($user->userDetail->campaign_permission == 1)
                            <span class="text-success">Active</span>
                        @elseif($user->userDetail->campaign_permission == 0)
                        <span class="text-danger">Suspend</span>
                        @endif
                    </td>
                    <td>
                        <a href="{{ route('admin.campaign-permission-active', $user->id) }}" onclick="return confirm('Are you sure?')" style="color: green;">Active</a>
                        |
                        <a href="{{ route('admin.campaign-permission-suspend', $user->id) }}" onclick="return confirm('Are you sure?')" style="color: red;">Suspend</a>
                    </td>
                </tr>
                @endforeach
                </tbody>
