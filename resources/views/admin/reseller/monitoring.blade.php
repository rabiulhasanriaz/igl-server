        ...
        <div class="widget-box">
            <div class="widget-header widget-header-flat">
                ...
                <div class="widget-toolbar">
                    <a href="{{ route('admin.reseller.sms_monitoring', ['date' => $prevMonth]) }}" class="btn btn-sm btn-default">
                        <i class="ace-icon fa fa-chevron-left"></i> Prev Month
                    </a>
                    <a href="{{ route('admin.reseller.sms_monitoring', ['date' => $nextMonth]) }}" class="btn btn-sm btn-default">
                ...
                <div class="widget-main">
                    ...
                    <div class="row" style="margin: -2px;">
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-2 col-lg-1" style="padding: 2px; margin-bottom: 5px;">
                            <a href="{{ route('admin.reseller.sms_monitoring', ['date' => $day['date']]) }}" 
            ...
            <div class="col-sm-2">
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <div class="clearfix">
                                <span class="pull-left" style="font-size: 18px; font-weight: bold;" id="total-sms">{{ number_format($totalSms) }}</span>
            ...
            <div class="col-sm-2">
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <div class="clearfix">
                                <span class="pull-left" style="font-size: 18px; font-weight: bold; color: #2c9c5c;" id="masking-count">{{ number_format($maskingCount) }}</span>
                                <span class="pull-right">
                                    <i class="ace-icon fa fa-shield fa-2x" style="color: #2c9c5c;"></i>
                                </span>
                            </div>
                            <div class="progress progress-mini">
                                <div class="progress-bar" style="width: {{ $totalSms > 0 ? ($maskingCount/$totalSms)*100 : 0 }}%; background-color: #2c9c5c;"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-2">
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <div class="clearfix">
                                <span class="pull-left" style="font-size: 18px; font-weight: bold; color: #ff8c42;" id="non-masking-count">{{ number_format($nonMaskingCount) }}</span>
                                <span class="pull-right">
                                    <i class="ace-icon fa fa-eye-slash fa-2x" style="color: #ff8c42;"></i>
                                </span>
                            </div>
                            <div class="progress progress-mini">
                                <div class="progress-bar" style="width: {{ $totalSms > 0 ? ($nonMaskingCount/$totalSms)*100 : 0 }}%; background-color: #ff8c42;"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-2">
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <div class="clearfix">
                                <span class="pull-left" style="font-size: 18px; font-weight: bold;" id="active-users">{{ $activeUsers }} / {{ $allUsers }}</span>
                                <span class="pull-right">
                                    <i class="ace-icon fa fa-users fa-2x green"></i>
                                </span>
                            </div>
                            <div class="progress progress-mini">
                                <div class="progress-bar progress-bar-success" id="active-users-progress" style="width: {{ $allUsers > 0 ? ($activeUsers/$allUsers)*100 : 0 }}%;"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-2">
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <div class="clearfix">
                                <span class="pull-left" style="font-size: 18px; font-weight: bold;" id="inactive-users">{{ $inactiveUsers }} / {{ $allUsers }}</span>
                                <span class="pull-right">
                                    <i class="ace-icon fa fa-user-times fa-2x orange"></i>
                                </span>
                            </div>
                            <div class="progress progress-mini">
                                <div class="progress-bar progress-bar-warning" id="inactive-users-progress" style="width: {{ $allUsers > 0 ? ($inactiveUsers/$allUsers)*100 : 0 }}%;"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-2">
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <div class="clearfix">
                                <span class="pull-left" style="font-size: 18px; font-weight: bold;" id="activity-rate">{{ $allUsers > 0 ? number_format(($activeUsers/$allUsers)*100, 1) : 0 }}%</span>
                                <span class="pull-right">
                                    <i class="ace-icon fa fa-percent fa-2x blue"></i>
                                </span>
                            </div>
                            <div class="progress progress-mini">
                                <div class="progress-bar progress-bar-info" id="activity-rate-progress" style="width: {{ $allUsers > 0 ? ($activeUsers/$allUsers)*100 : 0 }}%;"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="widget-box">
                    <div class="widget-header widget-header-flat">
                        <h4 class="widget-title lighter">
                            Top Users on {{ date('M j, Y', strtotime($selectedDate)) }}
...
$(document).ready(function () {
    ...
    function loadChartData() {
        ...
        $.ajax({
            url: "{{ route('admin.reseller.sms_monitoring.chart_data') }}",
            type: "GET",
    ...
    function connectSSE() {
        ...
        try {
            ...
            eventSource = new EventSource("{{ route('admin.reseller.sms_monitoring.stream') }}");
