	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<form action="{{ route('admin.reseller.update', $userInfo->id) }}" method="post" class="form-horizontal" role="form"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" id="companyName" placeholder="Company name" name="company_name"
							   class="col-xs-10 col-sm-5" required="" value="{{ $userInfo->company_name }}"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" id="ResellerName" placeholder="Name" name="reseller_name"
							   class="col-xs-10 col-sm-5" required="" value="{{ $userInfo->userDetail['name'] }}"/>
						<span class="help-inline col-xs-12 col-sm-7">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-image-1"> Permission : </label>
