...
@section('reseller_registration_menu_class', 'active')
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="ResellerName" placeholder="Name" name="reseller_name"
                               class="col-xs-10 col-sm-5" required="" value="{{ old('reseller_name') }}"/>
                        <span class="help-inline col-xs-12 col-sm-7">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="mobileNumber" placeholder="Phone" name="phone"
                               class="col-xs-10 col-sm-5 input-mask-phone" onkeyup="checkPhoneExistence(this.value)" value="{{ old('phone') }}" data-mask="___________" required=""/>
                        <span class="help-inline col-xs-12 col-sm-7">
