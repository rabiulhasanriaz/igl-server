...
<div class="wrap">
    ...
    <div class="topbar">
        ...
        <div>
            ...
            <a
                ...
                href="{{ route('log-viewer.download', ['filename' => $filename]) }}"
            >
                Download
            </a>
    ...
    <div class="tabs">
        ...
        <a
            class="tab tab-error {{ $tab === 'error' ? 'active' : '' }}"
            href="{{ route('log-viewer.show', [
                'filename' => $filename,
                'tab' => 'error'
            ]) }}"
        >
        ...
        <a
            class="tab tab-success {{ $tab === 'success' ? 'active' : '' }}"
            href="{{ route('log-viewer.show', [
                'filename' => $filename,
                'tab' => 'success'
            ]) }}"
    ...
    <form
        class="filters"
        method="GET"
        action="{{ route('log-viewer.show', ['filename' => $filename]) }}"
    >
                    ...
                    <div class="entry-head-right">
                        ...
                        @if(!empty($entry['id']))
                            ...
                            <form
                                ...
                                method="POST"
                                action="{{ route('log-viewer.entry.delete', [
                                    'filename' => $filename,
                                    'entryId' => $entry['id']
                                ]) }}"
