            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form action="{{ route('admin.whitelistedIp.update', $user->id) }}" method="POST">
                            @csrf
